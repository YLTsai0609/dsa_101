...
class BinarySearchTree:
    ...
    def search_rec(self, troot, key):
        if troot:
            if key == troot._element:
                return True
            elif key < troot._element:
                return self.search_rec(troot._left, key)
            elif key > troot._element:
                return self.search_rec(troot._right, key)
        else:
            return False
...
B.inorder(B._root)
print()
print(B.search_rec(B._root, 60))
print(B.search_rec(B._root, 999))
